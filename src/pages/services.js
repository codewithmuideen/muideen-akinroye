...
const Services = () => {
  return (
    <>
      <Head>
        <title>MuideenAkinroye | Services</title>
        <meta
  name="description"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full px-4">
                {[
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/2348134324983?text=Hi,%20I%20am%20interested%20in%20getting%20a%20quote%20for%20${encodeURIComponent(
                        service.title
