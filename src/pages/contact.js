...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Muideen Akinroye | Contact</title>
        <meta
  name="description"
...
/>
      ...
      <main className="flex flex-col items-center w-full min-h-screen mt-12 mb-2 px-4">
        <Layout>
          ...
          <div className="text-center my-6">
            <AnimatedText style={{fontFamily: "'Montserrat', sans-serif;"}}
          ...
          <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-[#3c3c3c] p-8 shadow-lg rounded-lg w-full">
              <h2 className="text-2xl md:text-center font-bold text-gray-900 mb-4 dark:text-light" style={{fontFamily: "'Montserrat', sans-serif;"}}>Get in Touch</h2>
              
              <form onSubmit={handleSubmit} action="https://formsubmit.co/codewitmui@gmail.com" method="POST">
                
                {/* Name Field */}
                <div className="mb-4">
                  <label style={{fontFamily: "'Montserrat', sans-serif;"}} htmlFor="name" className="block text-lg font-bold md:text-center text-gray-700 dark:text-light">
                    Name
                  </label>
                ...
                {/* Email Field */}
                <div className="mb-4">
                  <label style={{fontFamily: "'Montserrat', sans-serif;"}} htmlFor="email" className="block text-lg font-bold md:text-center text-gray-700 dark:text-light">
                    Email
                  </label>
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                {/* Message Field */}
                <div className="mb-4">
                  <label style={{fontFamily: "'Montserrat', sans-serif;"}} htmlFor="message" className="block text-lg md:text-center font-bold text-gray-700 dark:text-light">
                    Message
                  </label>
                  <div className="mt-1 relative rounded-md shadow-sm">
 ...
 <div className="hidden lg:w-full border-b-2 border-gray-300 rounded-full my-6"></div>
            ...
            <div className="w-full">
              <h2 className="text-2xl md:text-center font-bold text-gray-900 mb-4 dark:text-white" style={{fontFamily: "'Montserrat', sans-serif;"}}>Find me Here</h2>
              <div className="h-80 w-full rounded-lg overflow-hidden shadow-lg">
              <iframe
  className="w-full h-full"
  src="https://www.google.com/maps/embed/v1/place?q=MaTech%20Nigeria%2C%20Plot%203%2C%20Opposite%20Government%20House%20Annex%2C%20Okefia%2C%20Osogbo%2C%20Osun%20State%2C%20Nigeria&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
  allowFullScreen
  frameBorder="0"
  scrolling="no"
  marginHeight="0"
